...
module.exports = {
SESSION_ID: process.env.SESSION_ID === undefined ? '' : process.env.SESSION_ID,VAJIRA-MD=XN0ywLgJ#6pUAP7SUYjy9AuViRUudPpvridp6K2m5RErAip5V20s
OWNER_NUMBER: process.env.OWNER_NUMBER === undefined ? '' : process.env.OWNER_NUMBER,   923123163055
